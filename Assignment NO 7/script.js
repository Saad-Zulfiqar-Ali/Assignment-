...
//   2:
 ...
 var userInputTraffic = prompt ("Input Colour Red For 'stop' Yellow For 'Slow Down' And Green For 'Go' ")
...
//  Scissors && Rock
else if ((userInput1 ==="Scissors" || userInput1 === "scissorsr") && (userInput2 === "Rock" || userInput2 === "rock")){
    console.log("Player 2 Is Winner");
...
// If Both Condition Are Flase Then 
...
var userConversoinType = prompt("type: 1 for Celsius to Fahrenheit, 2 for Fahrenheit to Celsius.")

if( userConversoinType === '1'){
...
var inputWeather = prompt ("Enter Weater")
